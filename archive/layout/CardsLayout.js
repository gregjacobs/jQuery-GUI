...
ui.layout.CardsLayout = Class.extend( ui.layout.Layout, {
	 ...
	 * element (much like the {@link ui.layout.FitLayout}, but this may be set to true to simply allow the child components to determine their own size.
	 */
	autoSize : false,
	
	/**
	 * @cfg {ui.layout.CardsLayout.AbstractTransition} transition The {@link ui.layout.CardsLayout.AbstractTransition AbstractTransition} subclass to use
	 * for switching between cards. The default transition is the {@link ui.layout.CardsLayout.SwitchTransition SwitchTransition}, which simply hides
	 ...
	 * 
	 * When using a {@link #transition} of {@link ui.layout.CardsLayout.SlideTransition}, it is recommended that this config is set
	...
	initLayout : function() {
		...
		if( !this.transition ) {
			this.transition = new ui.layout.CardsLayout.SwitchTransition();
		}
	 ...
	 *   {ui.layout.CardsLayout.AbstractTransition AbstractTransition} subclass that you are using for a list of valid options (if any).
	 */
	...
	/**
	 * Extended onDestroy method for the CardsLayout to destroy its CardsLayout {@link ui.layout.CardsLayout.AbstractTransition} object.
	 * 
	 * @protected
	 * @method onDestroy
	 */
...
ui.Container.registerLayout( 'cards', ui.layout.CardsLayout );
