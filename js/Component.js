...
ui.Component = Class.extend( Jux.util.Observable, { 
	...
	render : function( containerEl, options ) {
		...
		var position;
		if( Jux.isNumber( options ) || Jux.isString( options ) || Jux.isElement( options ) || Jux.isJQuery( options ) ) {
			position = options;
