 ...
 */
/*global Class, Jux, ui */
ui.layout.TabsLayout = Class.extend( ui.layout.Layout, {
	...
	initLayout : function() {
		...
		this.addEvents(
			 ...
			 * @param {ui.layout.TabsLayout} tabsLayout This TabsLayout instance.
	...
	resizeContentDivs : function( $targetEl ) {
		...
		var $contentDivEls = this.$contentDivEls,
		    ...
		    contentHeight = containerHeight - tabHeadersHeight - Jux.Css.getFrameSize( $contentDivEls.filter( ':visible' ), 'tb' );  // measure the content div that is currently visible for padding/margin/borderWidth
	...
	onTabChange : function() {
		...
		if( newTab instanceof ui.Container ) {
			newTab.doLayout();
		}
...
ui.Container.registerLayout( 'tabs', ui.layout.TabsLayout );
