Ext.test.Session.addTest( 'Kevlar.ui', {
	...
	name: 'Kevlar.ui.DataControl',
	
	
	setUp : function() {
		// A Component DataControl with implemented setData() and getData() methods used for testing.
		var TestDataControlComponent = Kevlar.extend( ui.Component, [ ui.DataControl ], {
		...
		var TestDataControlContainer = Kevlar.extend( ui.Container, [ ui.DataControl ], {
			initComponent : function() {
