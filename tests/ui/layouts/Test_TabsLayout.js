Ext.test.Session.addSuite( 'ui.layouts', {
                                                 
    name: 'Kevlar.ui.layouts.TabsLayout',
	...
	items : [
		 ...
		 */
		{
			...
			"getActiveTab() should work" : function() {
				...
				var layout = container.getLayout();
				Y.Assert.isInstanceOf( ui.layouts.TabsLayout, layout, "initial condition failed. Container should have had TabsLayout." );
